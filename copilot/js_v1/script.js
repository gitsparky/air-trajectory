...
function calibrateVelocity() {
    ...
    const launchAngle = parseFloat(document.getElementById('calibrateVelocityAngle').value);
...
function calibrateAngle() {
    ...
    const launchVelocity = parseFloat(document.getElementById('calibrateAngleVelocity').value);
